...
export const paths: Record<string, React.ReactElement> = {
  bolt: (
    <path
  ...
  trash: (
    <path
      d="M4 7h16M9 7V4.8c0-.44.36-.8.8-.8h4.4c.44 0 .8.36.8.8V7m-9 0 .9 12.1a2 2 0 0 0 2 1.9h4.2a2 2 0 0 0 2-1.9L17 7M10 11v6M14 11v6"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
  ),
...
/** Narrows an arbitrary string (e.g. from the backend) to a known IconName, given a fallback. */
export function toIconName(value: string, fallback: IconName): IconName {
  return iconNameSet.has(value) ? (value as IconName) : fallback;
}
